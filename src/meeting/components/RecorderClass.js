...
import transcribe_credentials from '../../transcribe_credentials';
...
export default class MicRecorder {
    constructor() {
        ...
        this.access_key = transcribe_credentials.access_key
        this.secret_key = transcribe_credentials.secret_key
